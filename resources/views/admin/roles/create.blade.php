        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-input" value="{{ old('name') }}" 
                       ...
                       title="يجب أن يكون بالإنجليزية الصغيرة مع الشرطة السفلية فقط">
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-textarea" rows="3" placeholder="وصف مختصر للدور ومسؤولياته">{{ old('description') }}</textarea>
            </div>
        </div>
