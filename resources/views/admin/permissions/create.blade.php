...
<form action="{{ route('admin.permissions.store') }}" method="POST">
    ...
    <div class="form-card">
        <div class="form-group">
            ...
            <p class="form-hint">استخدم الأحرف الإنجليزية الصغيرة والنقاط فقط (مثال: users.create, properties.edit)</p>
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="text" name="display_name" class="form-input" value="{{ old('display_name') }}" 
        ...
        <div class="form-group">
            ...
            <input type="text" name="group" class="form-input" value="{{ old('group') }}" 
            ...
            <p class="form-hint">لتجميع الصلاحيات ذات الصلة معاً</p>
        </div>
        
        <div class="form-group">
            <label class="form-label">الوصف</label>
            <textarea name="description" class="form-textarea" rows="3" placeholder="وصف مختصر للصلاحية">{{ old('description') }}</textarea>
        </div>
